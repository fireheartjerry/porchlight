...
import { eventsUrl, qk } from '../api'
import type { ConnectionState, DemoProgress, TraceEvent, TraceEventType } from '../types'
...
export function useEventStream(): EventsApi {
  ...
  return useMemo<EventsApi>(
    ...
    [events, status, paused, clear, demoProgress, clearDemoProgress, lastEventAt],
  )
}
